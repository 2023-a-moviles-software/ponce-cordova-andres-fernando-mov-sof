...
import com.andresponce.exameniib.configuracion.ConfiguracionMapa
...
class CrearLugarActivity : AppCompatActivity(), RecyclerViewCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonCrearLugar.setOnClickListener {
            ...
            try {
                DaoFactory.daoFactory(this).getLugarDao().insertar(nuevoLugar)
