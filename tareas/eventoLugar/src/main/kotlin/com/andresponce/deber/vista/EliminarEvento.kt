...
class EliminarEvento(): JFrame() {
    ...
    private fun initComponents() {
        jLabel1 = JLabel()
        jTextFieldIDEventoBorrar = JTextField()
        jButtonBorrarEvento = JButton()
        defaultCloseOperation = DISPOSE_ON_CLOSE
        jLabel1!!.text = "ID Evento a borrar:"
            ...
            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(
                    layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldIDEventoBorrar)
                        .addContainerGap()
                )
                .addGroup(
                    layout.createSequentialGroup()
    ...
    private fun jButtonBorrarEventoActionPerformed(evt: ActionEvent) { //GEN-FIRST:event_jButtonBorrarEventoActionPerformed
        try {
            val id = jTextFieldIDEventoBorrar!!.text.toInt()
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                DaoFactory.daoFactory.getEventoDao().eliminar(id)
    ...
    private var jTextFieldIDEventoBorrar: JTextField? = null // End of variables declaration//GEN-END:variables
    ...
    companion object {
         ...
         */
            try {
                ...
                Logger.getLogger(EliminarEvento::class.java.name).log(Level.SEVERE, null, ex)
            ...
            /* Create and display the form */EventQueue.invokeLater { EliminarEvento().isVisible = true }
        }
    }
}